      ...
      <section className="relative overflow-hidden flex items-center justify-center py-14 md:py-20">
        ...
        <div className="z-10 relative flex flex-col md:flex-row gap-6 lg:gap-16">
          ...
          <div className="flex flex-col">
            ...
            <button className="bg-white/20 bg-blur capitalize mt-5 lg:mt-auto text-lg w-[95vw] rounded-md border-white/10 border-2 sm:w-full py-2 state-effects">Get Tickets</button>
          </div>
        </div>
      </section>
